  ...
  return (
    <aside className="w-60 flex flex-col bg-white border-r border-gray-200 shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100">
        ...
        <div>
          <div className="font-bold text-gray-900 text-sm leading-tight">PRIMAX</div>
          <div className="text-xs text-gray-400 leading-tight">Cusco · Dashboard</div>
        </div>
      </div>
      ...
      <div className="px-5 py-4 border-t border-gray-100">
        <div className="text-xs text-gray-400">
          <div className="font-medium text-gray-500 mb-0.5">Primax Cusco</div>
          <div>v1.0 · 13 estaciones</div>
        </div>
      </div>
    </aside>
  );
